...
public class FractionTester
{
  ...
  public static void drReduce() // All the driver methods are set up the same way, the opening prompts, and it sends stuff to the methods and returns stuff back; I'm not commenting them
  {
    ...
    fraction demo = new fraction(numerator, denominator);
    
    System.out.println();
    spacing("The fraction you entered is: " + demo.toString());
    System.out.println();
  ...
  public static void drAddition()
  {
    ...
    fraction demo1 = new fraction(numerator1, denominator1);
    ...
    fraction demo2 = new fraction(numerator2, denominator2);
  ...
  public static void drSubtraction()
  {
    ...
    System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
    System.out.println();
    spacing("Welcome to the Subtraction Demo!");
    System.out.println();
    spacing("Enter the first fraction's numerator: ", 2);
